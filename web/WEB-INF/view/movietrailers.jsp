...
<body>
    ...
    <div class="container">
        ...
        <h1 style="color: white">Fifty Shades Darker Trailers</h1>
        <div class="row">
            <ul id="overviewList">
                ...
                <li class="active"><a href="./movietrailers.html">Trailers</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12" id="movieDesc">
                            <div id="stats">
                                ...
                                <button class="btn-danger" style="width: 100%">Buy Tickets</button>
                            </div>
