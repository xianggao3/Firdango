...
<head>
    ...
    -->
    <link href="https://fonts.googleapis.com/css?family=Raleway:300|Roboto|Maven+Pro|Josefin+Sans:300,400"
          rel="stylesheet">
...
<div class="container">
    <div class="container-fluid">
        ...
        <ul id="overviewList">
            ...
            <li><a href="/category/genre">MOVIE GENRES</a></li>
                ...
                <div class="card-deck">
                    <c:forEach var="col" begin="0" end="3">
                        ...
                        <a href="${overviewLink}" class="card card-inverse text-center">
                            <img class="card-img-top" src="https://image.tmdb.org/t/p/w500//${movies[row*4+col].poster}"
                                 alt="">
